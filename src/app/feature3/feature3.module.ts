...
import { Child13Component } from './child1/child1-3/child1-3.component';
...
@NgModule({
  ...
  declarations: [Feature3Component, Child1Component, Child11Component, Child12Component, Child13Component]
})
